...
public class project implements ActionListener {
	...
	static String[] TransType = { "Deposit", "Withdrawal", "Check Deposit" };
	...
	static String[] columnName = { "Date", "Trans.Type", "Check NO.", "Trans.Description", "Withdrawal (-)",
			"Deposit (+)", "Balance" };
	static int Tnumber = 0;

	public static void main(String[] args) {
		/*
		 * Creating JFrames and JButtons 
		 */
		...
		title.add(new JLabel("<html><font size=5><b>Use The Buttons Below To Manage Transactions</b></html>",
		...
		buttons.add(loadf = new JButton("Load Account from a File"));
		buttons.add(add = new JButton("Add New Transactions"));
		buttons.add(view = new JButton("View/Delete Transactions"));
		buttons.add(save = new JButton("Save Account to a File"));
		...
		/*
		 * Create a new account page view
		 */
		...
		/*
		 * Load Trans from a File page view
		 */
		...
		/*
		 * Adding new transactions page view 
		 */
		...
		/*
		 * Search transactions page view 
		 * The view is completed but we do not have enough time to complete the functions 
		 * So we took out the "Search Transactions" button from the main page
		 */
		JPanel search = new JPanel(new BorderLayout());
		search.add(new JLabel("Search Transactions by Transaction Date/Type/Check NO./Description", JLabel.CENTER),
				BorderLayout.NORTH);
		...
		/*
		 * Sort transactions page view 
		 * The view is completed but the functions are not 
		 * Again, we took out this button from the main page
		 */
		...
		/*
		 * View/Delete Transactions page view
		 */
		JPanel transBook = new JPanel(new BorderLayout());
		transBook.add(new JLabel("Transactions Currently In The Account", JLabel.CENTER), BorderLayout.NORTH);
	...
	public void actionPerformed(ActionEvent e) {
		/*
		 * Function of the drop down menu of transaction types
		 */
		...
		/*
		 * Function of saving an account information into a file 
		 */
		if (source == save) {
			try {
				FileOutputStream fos = new FileOutputStream(accountName.getText(), false);
		...
		/*
		 * Function of loading an account information from a file 
		 */
		if (source == load1) {
			try {
		...
		/*
		 * Function of deleting a transaction from the transactions list
		 */
		...
		/*
		 * Function of showing transactions in a table
		 */
		if (source == view) {
			String[][] data = new String[Tnumber][8];
			Balance = 0;
		...
		/*
		 * Function of creating a new account, saving the account name and initial balance
		 */
		if (source == create) {
		...
		/*
		 * Function of saving a new transaction
		 * Identify which transaction it is and update account balance accordingly
		 */
		if (source == saveNew) {
			Transaction T = new Transaction();
